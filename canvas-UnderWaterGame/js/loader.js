...
const IMAGES_UPLOAD_ARR = [
    ...
    'Bullet_Player_10x40px.png',
    'seaUrchin_167x180px.png',
    'explosion_200x200px_16frames.png',
    'Bone_Fish_52x78px.png',
    'enemy_bullet_10x40px.png',
    'player_rocket_30x12px.png',
    'bigoctopus_170x170px.png',
    'warden_120x120px.png',
    'devilfish_102x240px.png',
    'OctopusBullet.png',
    'Bone_Fish_Bullet_10x40px.png',
